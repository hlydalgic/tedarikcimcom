  ...
  return (
    <section className="relative isolate min-h-[78vh] overflow-hidden md:min-h-[82vh]">
      ...
      <div
        ...
        style={{
          background:
            "linear-gradient(90deg, rgba(6,21,40,0.88) 0%, rgba(6,21,40,0.78) 38%, rgba(6,21,40,0.35) 68%, rgba(6,21,40,0.12) 100%)",
        }}
      />
      <div
        ...
        style={{
          background:
            "linear-gradient(180deg, rgba(6,21,40,0.82) 0%, rgba(6,21,40,0.55) 55%, rgba(6,21,40,0.35) 100%)",
        }}
      />
